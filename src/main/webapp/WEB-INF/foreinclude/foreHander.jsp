            ...
            <div class="row">
                <div class="col-12 col-lg-6">
                    <div class="header-top-text text-center text-lg-left mb-0 mb-md-15 mb-sm-15">
                        <p><i class="icon ion-md-alarm"></i> 为您提供中国和世界的旅游景点大全，旅游景点推荐等信息 <span class="support-no">: (012) 800 456 789</span></p>
                    </div>
                </div>
                <div class="col-12 col-lg-6">
                    ...
                    <div class="header-top-dropdown d-flex justify-content-center justify-content-lg-end">
                        ...
                        <c:if test="${cst==null}">
                            ...
                            <span class="separator pl-15 pr-15">|</span>
                            <div class="single-dropdown">
                                <a href="${pageContext.request.contextPath}/login"><span>管理员登录</span></a>
                            </div>
                        </c:if>
                        <!--=======  End of single dropdown  =======-->
            ...
            <div class="row align-items-center">
                <div class="col-12 col-lg-7">
                    ...
                    <div class="main-menu">
                        <nav>
                            <ul>
                                <li class="active menu-item-has-children"><a href="#">城市</a>
                                    <ul class="sub-menu">
                                ...
                                <li><a href="/fore/foreZixuns">自助资讯</a></li>
