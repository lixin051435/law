...
<article class="cl pd-20">
    <form action="/product/updateProduct" method="post" enctype="multipart/form-data" class="form form-horizontal" id="form-admin-add"  target="_parent">
        <div class="row cl">
            <label class="form-label col-xs-4 col-sm-3"><span class="c-red">*</span>景点名称：</label>
        ...
        <%--<div class="row cl">--%>
            ...
            <%--<div class="formControls col-xs-8 col-sm-9">--%>
                <%--<input type="text" class="input-text" autocomplete="off" value="${景点已被下架，请浏览其他景点}" placeholder="" id="price" name="price">--%>
            <%--</div>--%>
        <%--</div>--%>
        <div class="row cl">
       ...
       <div class="row cl">
           ...
           <label class="form-label col-xs-4 col-sm-3"><span class="c-red"></span>景点图片：</label>
           <div class="formControls col-xs-8 col-sm-9">
        ...
        <div class="row cl">
            <label class="form-label col-xs-4 col-sm-3"><span class="c-red"></span>景点语音：</label>
            <div class="formControls col-xs-8 col-sm-9">
