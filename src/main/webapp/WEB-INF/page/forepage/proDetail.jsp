<%@ page import="com.byh.biyesheji.pojo.Product" %><%--
                ...
                <div class="breadcrumb-container">
                    <nav>
                        <ul>
                            ...
                            <li class="parent-page"><a href="#">景点</a></li>
                            <li>详细信息</li>
                        </ul>
                    </nav>
                </div>
        ...
        <div class="row">
            ...
            <div class="col-lg-6 col-md-6 col-xs-12">
                ...
                <div class="product-feature-details">
                    ...
                    <%--&lt;%&ndash;<span class="discounted-price"> $${product.price}</span>&ndash;%&gt;--%>
                    <%--</h2>--%>
                        ...
                        <div class="fl-product">
                            ...
                            <div class="content">
                                ...
                                <div class="rating">
                                    ...
                                    <%--&lt;%&ndash;<span class="discounted-price">$${pf.price}</span>&ndash;%&gt;--%>
                                    <%--</p>--%>
                            </div>
                        </div>
                    </c:forEach>
...
<%
    ...
    String musicurl = product.getMusicurl();
...
<iframe src="${pageContext.request.contextPath}/${product.musicurl}" allow="autoplay" style="display:none" id="iframeAudio"></iframe>